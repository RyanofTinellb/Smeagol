...
class Row:
    def __init__(self, parent, name, filename, optional, window, row):
        self.parent = parent
        self.name = name
    ...
    def ready_label(self):
        ...
        self.labelvar.set(self.name.title())
    ...
    def ready_buttons(self):
        state = tk.NORMAL if self.optional else tk.DISABLED
    ...
    def change_name(self):
        ...
        self.labelvar.set(title(name) or self.labelvar.get())
